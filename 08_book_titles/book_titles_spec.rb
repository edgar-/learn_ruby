...
describe Book do
  ...
  describe 'title' do
    it 'should capitalize the first letter' do
      @book.title = "inferno"
      expect(@book.title) == "Inferno"
    end

    it 'should capitalize every word' do
      @book.title = "stuart little"
      expect(@book.title) == "Stuart Little"
    end
    ...
    describe 'should capitalize every word except...' do
      describe 'articles' do
        specify 'the' do
          ...
          expect(@book.title) == "Alexander the Great"
        end
        ...
        specify 'an' do
          ...
          expect(@book.title) == "To Eat an Apple a Day"
        end
      end
      ...
      specify 'prepositions' do
        ...
        expect(@book.title) == "Love in the Time of Cholera"
      end
    end
    ...
    describe 'should always capitalize...' do
      specify 'I' do
        ...
        expect(@book.title) == "What I Wish I Knew When I Was 20"
      end

      specify 'the first word' do
        @book.title = "the man in the iron mask"
        expect(@book.title) == "The Man in the Iron Mask"
      end
    end
  end
end
