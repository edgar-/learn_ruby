...
describe Dictionary do
  ...
  it 'can add whole entries with keyword and definition' do
    ...
    expect(@d.entries) == {'fish' => 'aquatic animal'}
    expect(@d.keywords) == ['fish']
  end

  it 'add keywords (without definition)' do
    @d.add('fish')
    expect(@d.entries) == {'fish' => nil}
    expect(@d.keywords) == ['fish']
  end
  ...
  it "finds an entry" do
    @d.add('fish' => 'aquatic animal')
    expect(@d.find('fish')) == {'fish' => 'aquatic animal'}
  end
  ...
  it 'finds multiple matches from a prefix and returns the entire entry (keyword + definition)' do
    ...
    expect(@d.find('fi')) == {'fish' => 'aquatic animal', 'fiend' => 'wicked person'}
  end
  ...
  it 'lists keywords alphabetically' do
    ...
    @d.add('fish' => 'aquatic animal')
    @d.add('apple' => 'fruit')
    expect(@d.keywords) == %w(apple fish zebra)
  end
  ...
  it 'can produce printable output like so: [keyword] "definition"' do
    ...
    @d.add('fish' => 'aquatic animal')
    @d.add('apple' => 'fruit')
    expect(@d.printable) == %Q{[apple] "fruit"\n[fish] "aquatic animal"\n[zebra] "African land animal with stripes"}
  end
end
