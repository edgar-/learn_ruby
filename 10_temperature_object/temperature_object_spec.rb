...
describe Temperature do
  ...
  describe "can be constructed with an options hash" do
    describe "in degrees fahrenheit" do
      it "at 50 degrees" do
        expect(Temperature.new(:f => 50).in_fahrenheit) == 50
      end

      describe "and correctly convert to celsius" do
        it "at freezing" do
          expect(Temperature.new(:f => 32).in_celsius) == 0
        end

        it "at boiling" do
          expect(Temperature.new(:f => 212).in_celsius) == 100
        end

        it "at body temperature" do
          expect(Temperature.new(:f => 98.6).in_celsius) == 37
        end

        it "at an arbitrary temperature" do
          expect(Temperature.new(:f => 68).in_celsius) == 20
        end
      end
    end
    ...
    describe "in degrees celsius" do
      it "at 50 degrees" do
        expect(Temperature.new(:c => 50).in_celsius) == 50
      end

      describe "and correctly convert to fahrenheit" do
        it "at freezing" do
          expect(Temperature.new(:c => 0).in_fahrenheit) == 32
        end

        it "at boiling" do
          expect(Temperature.new(:c => 100).in_fahrenheit) == 212
        end
  ...
  describe "can be constructed via factory methods" do
    ...
    it "in degrees celsius" do
      expect(Temperature.from_celsius(50).in_celsius) == 50
      expect(Temperature.from_celsius(50).in_fahrenheit) == 122
    end

    it "in degrees fahrenheit" do
      expect(Temperature.from_fahrenheit(50).in_fahrenheit) == 50
      expect(Temperature.from_fahrenheit(50).in_celsius) == 10
    end
  ...
  describe "Temperature subclasses" do
    describe "Celsius subclass" do
      it "is constructed in degrees celsius" do
        expect(Celsius.new(50).in_celsius) == 50
        expect(Celsius.new(50).in_fahrenheit) == 122
      end
    ...
    describe "Fahrenheit subclass" do
      it "is constructed in degrees fahrenheit" do
        expect(Fahrenheit.new(50).in_fahrenheit) == 50
        expect(Fahrenheit.new(50).in_celsius) == 10
      end
